module github.com/TIBCOSoftware/labs-air/edgexfoundry/device-opcua-go
...
require (
	...
	github.com/gopcua/opcua v0.0.0-20191111124717-762ddda1ae9a
...
replace (
	...
	golang.org/x/crypto v0.0.0-20190621222207-cc06ce4a13d4 => github.com/golang/crypto v0.0.0-20190621222207-cc06ce4a13d4
)
...
replace (
	...
	golang.org/x/sys v0.0.0-20190624142023-c5567b49c5d0 => github.com/golang/sys v0.0.0-20190624142023-c5567b49c5d0
)
